...
NSInteger const yPointNumber = 5; //y轴上点的个数
...
//        }
//        yTitleArray =  [NSMutableArray arrayWithObjects:@"20",@"40",@"60",@"80",@"100",@"120",@"140",@"160",@"180",@"200", nil];
    ...
    for (int j = 0; j< pointNumber+1; j++) {
        ...
        yTitleLabel.textColor = RGB(138, 138, 138);
    ...
    unitLabel.textColor = RGB(138, 138, 138);
    ...
    for (int k = 0; k<xCount; k++) {
        ...
        xTitleLabel.textColor = RGB(138, 138, 138);
        //各个柱子顶部的中点的x坐标
    ...
    xUnitLabel.textColor = RGB(138, 138, 138);
    xUnitLabel.font = [UIFont systemFontOfSize:10.0f];
