...
//    [_buttonLeft setBackgroundColor:[UIColor lightGrayColor]];
//    [_buttonRight setBackgroundColor:RGB(77, 207, 199)];
...
- (void)setTitleColor:(UIColor *)titleColor
{
    ...
    [self.buttonLeft setTitleColor:RGB(138, 138, 138) forState:UIControlStateNormal];
    [self.buttonRight setTitleColor:RGB(77, 207, 199) forState:UIControlStateNormal];
}
...
- (UIButton *)buttonRight
{
    if (!_buttonRight) {
        ...
        [_buttonRight setTitleColor:RGB(77, 207, 199) forState:UIControlStateNormal];
