...
-(void)setupUI
{
    ...
    NSAttributedString *attrString = [[NSAttributedString alloc] initWithString:NSLocalizedString(@"can_you_concern_device_fragment_cancel",nil)attributes:
                                      @{ NSForegroundColorAttributeName: RGB(138, 138, 138),
    ...
    NSAttributedString *attrString2 = [[NSAttributedString alloc] initWithString:NSLocalizedString(@"replace_weight_fragment_yes",nil) attributes:
                                       @{ NSForegroundColorAttributeName: RGB(77, 207, 199),
                                          NSFontAttributeName :           [UIFont systemFontOfSize:16],
                                          NSUnderlineStyleAttributeName : @(NSUnderlineStyleNone) }];
