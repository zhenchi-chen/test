...
- (id)initWithFrame:(CGRect)frame
{
    if (self = [super initWithFrame:frame]) {
        self.pullToRefreshText = NSLocalizedString(@"xlistview_footer_hint_pull-up", nil);
        self.releaseToRefreshText = NSLocalizedString(@"xlistview_footer_hint_Let_go-up", nil);
        self.refreshingText = NSLocalizedString(@"xlistview_footer_hint_loading", nil);
    }
    return self;
}
