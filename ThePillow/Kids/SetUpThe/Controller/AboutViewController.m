...
- (void)initHeadView {
    ...
    logoIv.image = [UIImage imageNamed:@"app_store"];
    ...
    UIImage * image = [UIImage imageOfQRFromURL: @"https://itunes.apple.com/cn/app/thepillow/id1187813681?mt=8" codeSize: 100 red: 0 green: 0 blue: 0 insertImage: [UIImage imageNamed: @"app_store"] roundRadius: 15.0f];
