...
-(void)handeTap:(UITapGestureRecognizer *)tap{
    ...
    if ((!self.closed) && (tap.state == UIGestureRecognizerStateEnded))
    {
        ...
        [[NSNotificationCenter defaultCenter] postNotification:[NSNotification notificationWithName:@"closeLeftView" object:nil]];
    }
...
- (void)openLeftView;
{
    ...
    [[NSNotificationCenter defaultCenter] postNotification:[NSNotification notificationWithName:@"openLeftView" object:nil]];
}
